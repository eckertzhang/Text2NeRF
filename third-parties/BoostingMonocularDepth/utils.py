"""
Author: Eckert ZHANG
Date: 2022-06-21 18:13:11
LastEditTime: 2022-07-05 20:22:27
LastEditors: Eckert ZHANG
FilePath: /BoostingMonocularDepth/utils.py
Description: 
"""
import os
import cv2
...
class ImageDataset_single:
    def __init__(self, root_dir, subsetname):
        self.dataset_dir = root_dir
        self.subsetname = subsetname
        self.rgb_image_dir = root_dir
        self.files = sorted(os.listdir(self.rgb_image_dir))[-1:]
